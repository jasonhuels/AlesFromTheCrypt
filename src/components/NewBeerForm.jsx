...
function NewBeerForm(props) {
  ...
  function handleSubmission(event) {
    ...
    props.onAddNewBeer({ name: name.value, photoPath: photoPath.value, style: type.value, abv: abv.value, price: price.value, description: description.value, pintsLeft: 124, id: v4() });
    name.value = "";
    photoPath.value = "";
    type.value = "";
    abv.value = "";
